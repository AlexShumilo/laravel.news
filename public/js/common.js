$(document).ready(function() {
    ...
    $(document).on('click', 'a.paginator-link', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (result) {
                var comments = $(result).find('#news_comments').html();
                $('#news_comments').html(comments);
            	var elements = $(result).find('#news-comments-paginator').html();
                $('#news-comments-paginator').html(elements);
